...
export function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-brand-50 to-blue-50 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center p-6">
      {/* Theme toggle */}
      <button
        onClick={toggleTheme}
